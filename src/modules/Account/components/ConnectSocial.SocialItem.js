...
import { FacebookIcon, GoogleIcon } from '../../../sharedComponents/components';
...
const LeftColumn = props => {
  ...
  return (
    <Box className={props?.className ? props?.className : classes.itemContainer}>
      <Checkbox
      ...
      <Box marginTop=".5rem" display="flex" justifyContent="center" width="100%">
      </Box>
    </Box>
  );
};
