 ...
 * @returns
 */
const InstagramSocialDisplay = ({ currentCampaign }) => {
  ...
  return (
    <Card className={classes.root}>
      ...
      />
      <CardMedia className={classes.image} image={currentCampaign.file_url} />
      ...
      <CardContent>
        ...
        <Typography
          ...
          component="p"
        >
          <strong style={{ fontSize: '13px', color: '#1D447B' }}>{currentCampaign.headline2}</strong>{' '}
