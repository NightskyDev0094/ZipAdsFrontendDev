...
const PrivacyPolicy = () => (
  <Box style={{ margin: '10%' }}>
    <h1>Privacy Policy for mywebads.io</h1>

    <p>
      At mywebads.io, accessible from mywebads.io, one of our main priorities is the privacy of our
      visitors. This Privacy Policy document contains types of information that is collected and
      recorded by mywebads.io and how we use it.
    </p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in mywebads.io. This
    ...
    <p>
      mywebads.io follows a standard procedure of using log files. These files log visitors when
    ...
    <p>
      Like any other website, mywebads.io uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on mywebads.io,
    ...
    <p>
      Note that mywebads.io has no access to or control over these cookies that are used by
    ...
    <p>
      mywebads.io's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      mywebads.io does not knowingly collect any Personal Identifiable Information from children
