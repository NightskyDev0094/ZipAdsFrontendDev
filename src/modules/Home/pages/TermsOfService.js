...
import BlueTecLanding from '../../../BlueTecUIKit/BlueTecLanding';
  ...
  <Box style={{ margin: '10%' }}>
    <div>
      ...
      <p>
        ...
        personally or on behalf of an entity (“you”) and mywebads.io ("Company", “we”, “us”, or
        “our”), concerning your access to and use of the mywebads.io website as well as any other
        ...
        THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions or
        ...
        modifications to these Terms of Use at any time and for any reason. We will alert you about
        ...
        periodically review these Terms of Use to stay informed of updates. You will be subject to,
        ...
        Use are posted. The information provided on the Site is not intended for distribution to or
        ...
        (GLBA). The Site is intended for users who are at least 18 years old. Persons under the age
      ...
      <h2>FREE TRIAL</h2>
      <p>
        We offer a 30-day free trial to new users who register with the Site. The account will be
      ...
      <p>
        ...
        into your account or contacting us using the contact information provided below. Your
        cancellation will take effect at the end of the current paid term.
      </p>
      <p>
        If you are unsatisfied with our services, please email us at info@mywebads.io or call us at
        8285390498.
      </p>
      ...
      <p>
        ...
        mywebads.io/privacy-policy. By using the Site, you agree to be bound by our Privacy Policy,
      ...
      <p>
        ...
        the laws of the State of California applicable to agreements made and to be entirely
      ...
      <p>
        ...
        courts located in San Francisco, California, and the Parties hereby consent to, and waive
        all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue
        ...
        Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall
      ...
      <h5>mywebads.io</h5>
      <h5>1610 Robert E Lee Blvd</h5>
      <h5>New Orleans, LA 70122</h5>
      <h5>United States</h5>
      <h5>Phone: 8285390498</h5>
      <h5>info@mywebads.io</h5>
    </div>
  </Box>
);
