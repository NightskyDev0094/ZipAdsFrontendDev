    ...
    function u(t, e, o) {
      ...
      return (
        t.each((t, u) => {
          ...
          const d = h[e];
          if (!d || e.charAt(0) == '_') return void r(`${s} is not a valid method`);
          const l = d.apply(h, o);
          n = void 0 === n ? l : n;
        }),
        void 0 !== n ? n : t
  ...
  (function (t, e) {
    ...
    function o(t) {
      ...
      return (
        e ||
          a(
            `Style returned ${e}. Are you running this code in a hidden iframe on Firefox? See http://bit.ly/getsizebug1`
          ),
        e
      );
    }
    ...
    function s(e) {
      if (
        ...
        for (var d = (a.isBorderBox = s.boxSizing == 'border-box'), l = 0; l < h; l++) {
          const f = u[l];
          const c = s[f];
  ...
  (function (t, e) {
    ...
    (d.constructor = o),
      ...
      (d.getPosition = function () {
        ...
        let r = o.indexOf('%') != -1 ? (parseFloat(o) / 100) * s.width : parseInt(o, 10);
        let a = n.indexOf('%') != -1 ? (parseFloat(n) / 100) * s.height : parseInt(n, 10);
        (r = isNaN(r) ? 0 : r),
          (a = isNaN(a) ? 0 : a),
  ...
  (function (t, e) {
    ...
    o.extend(c, e.prototype),
      ...
      (c._find = function (t) {
        if (t)
          return (
            typeof t === 'string' && (t = this.element.querySelectorAll(t)), (t = o.makeArray(t))
          );
      }),
  ...
  (function (t, e) {
    ...
    return (
      ...
      (l.getFilteredItemElements = function () {
        return this.filteredItems.map((t) => t.element);
      }),
      d
    );
  });
