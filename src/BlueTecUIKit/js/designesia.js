...
(function ($) {
  ...
  const de_nav_style = 1; // 1 - solid, 2 - transparent
  const de_nav_color = 1; // 1 - dark, - 2 light
  const de_nav_color_scroll = 1; // 1 - default, - 2 light
  ...
  !(function (a) {
    a.fn.fitVids = function (b) {
      ...
      const e =
        document.getElementsByTagName('base')[0] || document.getElementsByTagName('script')[0];
      return (
        ...
        this.each(function () {
          ...
          d.each(function () {
            ...
            if (
              !(
                (this.tagName.toLowerCase() == 'embed' && b.parent('object').length) ||
                b.parent('.fluid-width-video-wrapper').length
              )
            ) {
              const c =
                this.tagName.toLowerCase() == 'object' || b.attr('height')
                  ? b.attr('height')
                  : b.height();
