!(function (a) {
  ...
  (t.prototype = {
    ...
    open(c) {
      ...
      (b.types = []),
        ...
        (b.fixedContentPos =
          b.st.fixedContentPos === 'auto' ? !b.probablyMobile : b.st.fixedContentPos),
        b.st.modal &&
    ...
    _openClick(c, d, e) {
      ...
      if (f || (c.which !== 2 && !c.ctrlKey && !c.metaKey)) {
              ...
              () =>
                d.naturalWidth > 0
                  ...
                  : (c > 200 && clearInterval(L),
                    c++,
                    void (c === 3 ? e(10) : c === 40 ? e(50) : c === 100 && e(500))),
              f
            ));
        };
        e(1);
  ...
  a.magnificPopup.registerModule('gallery', {
    ...
    proto: {
      initGallery() {
        ...
        const e = '.mfp-gallery';
        const g = Boolean(a.fn.mfpFastClick);
        return (
          (b.direction = !0),
          c && c.enabled
            ? ((f += ' mfp-gallery'),
  ...
  a.magnificPopup.registerModule(U, {
    ...
    (function () {
      const b = 1e3;
      const c = 'ontouchstart' in window;
      const d = function () {
        v.off(`touchmove${f} touchend${f}`);
      };
      const e = 'mfpFastClick';
      var f = `.${e}`;
