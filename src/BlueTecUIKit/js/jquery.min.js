!(function (a, b) {
  ...
  const t = (function (a) {
    ...
    function lb(a, b) {
      let c = b && a;
      const d =
        c && a.nodeType === 1 && b.nodeType === 1 && (~b.sourceIndex || C) - (~a.sourceIndex || C);
      if (d) return d;
        ...
        return g !== n && g.nodeType === 9 && g.documentElement
          ? ((n = g),
            ...
            (c.getElementsByTagName = jb(
              (a) => (a.appendChild(g.createComment('')), !a.getElementsByTagName('*').length)
            )),
      ...
      (d = gb.selectors = {
        ...
        filter: {
          ...
          PSEUDO(a, b) {
            let c;
            const e =
              d.pseudos[a] || d.setFilters[a.toLowerCase()] || gb.error(`unsupported pseudo: ${a}`);
            return e[u]
              ? e(b)
              : e.length > 1
              ? ((c = [a, a, '', b]),
      ...
      (d = a[g]),
        d.style &&
          ...
          b
            ...
            : ((e = S(d)),
              (c === 'none' && e) || L.set(d, 'olddisplay', e ? c : n.css(d, 'display'))));
    for (g = 0; h > g; g++)
      (d = a[g]),
        d.style &&
  ...
  n.extend({
    ...
    (n.cssHooks.marginRight = yb(k.reliableMarginRight, (a, b) =>
      b ? n.swap(a, { display: 'inline-block' }, xb, [a, 'marginRight']) : void 0
    )),
    ...
    if (n.isEmptyObject(m)) (j === 'none' ? tb(a.nodeName) : j) === 'inline' && (o.display = j);
      ...
      for (d in m)
        (g = Ub(p ? q[d] : 0, d, l)),
          d in q ||
            ((q[d] = g.start),
            p && ((g.end = g.start), (g.start = d === 'width' || d === 'height' ? 1 : 0)));
    }
  }
  function Wb(a, b) {
    let c;
        ...
        if (e)
          return (
            ...
            b && 'get' in b && void 0 !== (c = b.get(e, 'value'))
              ? c
              : ((c = e.value), typeof c === 'string' ? c.replace(bc, '') : c == null ? '' : c)
          );
      }
    },
  }),
                  ...
                  b &&
                    ...
                    a === 'abort'
                      ...
                      : d(
                          ...
                          f.statusText,
                          typeof f.responseText === 'string' ? { text: f.responseText } : void 0,
